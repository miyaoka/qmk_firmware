...
[L_QKDB] = KEYMAP(
    ...
    //righthand
    _______,    _______,    _______,    _______,    _______,    _______,    _______,
    _______,    KC_P,       KC_W,       KC_Y,       KC_J,       KC_SCLN,    _______,
                KC_H,       KC_N,       KC_I,       KC_O,       KC_E,       _______,
    _______,    KC_L,       KC_M,       KC_COMM,    KC_DOT,     KC_SLSH,    _______,
                            _______,    _______,    _______,    _______,    _______,
...
[L_GAME] = KEYMAP(
    ...
    _______,    _______,    KC_Q,       KC_W,       KC_E,       KC_R,       KC_ENT,
...
[L_GAME2] = KEYMAP(
    // left hand
    _______,    _______,    _______,    _______,    _______,    _______,    _______,
    _______,    KC_6,       KC_7,       KC_8,       KC_9,       KC_0,       KC_T,
    _______,    KC_F1,      KC_F2,      KC_F3,      KC_F4,      KC_F5,
    _______,    KC_F6,      KC_F7,      KC_F8,      KC_F9,      KC_F10,     KC_G,
    _______,    _______,    _______,    _______,    _______,
 ...
 *
 * ,--------------------------------------------------.           ,--------------------------------------------------.
 * |  RESET | Mac  | Win  |      |      |      |      |           |      | QWRT |      | game | ASNT | QKDB |        |
 * |--------+------+------+------+------+-------------|           |------+------+------+------+------+------+--------|
 * |        |      |      |      |      |      |      |           |      |      |      |      |      |      |        |
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * |        |      |      |      |      |      |------|           |------|      |      |      |      |      |        |
...
[L_CONF] = KEYMAP(
    ...
    //righthand
    _______,    TO(L_MAC, ON_PRESS), _______, TO(L_GAME, ON_PRESS), TO(L_ASNT, ON_PRESS), TO(L_QKDB, ON_PRESS),   _______,
    _______,    _______,    _______,    _______,    _______,    _______,    _______,
                _______,    _______,    _______,    _______,    _______,    _______,
    _______,    _______,    _______,    _______,    _______,    _______,    _______,
                            _______,    _______,    _______,    _______,    _______,
