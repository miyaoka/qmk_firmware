...
[L_COMMON] = KEYMAP(  // layer 0 : default
  ...
  KC_TAB,     _______,    _______,    _______,    _______,    _______,    KC_LT,
  ...
  KC_GT,      _______,    _______,    _______,    _______,    _______,    KC_CAPS,
 ...
 * |        |  F1  |  F2  |  F3  |  F4  |  F5  |  F11 |           | F12  |  F6  |  F7  |  F8  |  F9  |  F10 | ->CNF  |
 * |--------+------+------+------+------+-------------|           |------+------+------+------+------+------+--------|
 * |        |      | PREV | M_U  | NEXT | Home |  <   |           |  >   |      | PgDn | PgUp | Space|      |        |
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 ...
 */
 [L_NAV2] = KEYMAP(
  // left hand
  _______,    KC_F1,      KC_F2,      KC_F3,      KC_F4,      KC_F5,      KC_F11,
  _______,    _______,    KC_PREV,    KC_M_U,     KC_NEXT,    KC_HOME,    KC_LT,
  ...
  //righthand
  KC_F12,     KC_F6,      KC_F7,      KC_F8,      KC_F9,      KC_F10,     MO(L_CONF),
  KC_GT,      _______,    KC_PGDN,    KC_PGUP,    KC_SPC,     _______,    _______,
