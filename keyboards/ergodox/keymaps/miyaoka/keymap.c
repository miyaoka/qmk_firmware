...
[L_COMMON] = KEYMAP(  // layer 0 : default
  ...
  KC_LGUI,    MO(L_NUM),  KC_BSLS,    KC_GRV,     SFT_T(KC_LBRC),

              _______,    _______,
                          _______,
  _______,    CK_A_EN,    LT(L_NUM, KC_ESC),
  ...
  KC_EQL,     _______,    _______,    _______,    _______,    _______,    SFT_T(KC_KP_PLUS),
                          SFT_T(KC_RBRC),    KC_BSPC,    KC_DEL,     _______,    _______,
...
[L_MAC] = KEYMAP(  // layer 0 : default
  ...
  //righthand
  _______,    _______,    _______,    _______,    _______,    _______,    _______,
  _______,    _______,    _______,    _______,    _______,    _______,    LSFT(LGUI(KC_4)),
              _______,    _______,    _______,    _______,    _______,    _______,
  _______,    _______,    _______,    _______,    _______,    _______,    _______,
                          _______,    _______,    _______,    _______,    _______,
 ...
 * |        |  F1  |  F2  |  F3  |  F4  |  F5  |  F11 |           | F12  |  F6  |  F7  |  F8  |  F9  |  F10 | ->CNF  |
 * |--------+------+------+------+------+-------------|           |------+------+------+------+------+------+--------|
 * |        |      | PREV | M_U  | NEXT | Home |      |           | MW_D |      | PgDn | PgUp | Space| LAlt |        |
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * |   (    |   ?  | M_L  | M_D  | M_R  | End  |------|           |------| Left | Down |  Up  | Right|   :  |   )    |
 * |--------+------+------+------+------+------|      |           | MW_U |------+------+------+------+------+--------|
 * |        |   !  |   @  |   #  |   $  |   %  |      |           |      |   ^  |   &  |   *  |   (  |   )  |        |
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |      | LGUI |      |      | MBtn3|                                       |   |  |      |      |      |      |
 ...
 */
 [L_NAV2] = KEYMAP(
  // left hand
  _______,    KC_F1,      KC_F2,      KC_F3,      KC_F4,      KC_F5,      KC_F11,
  _______,    _______,    KC_PREV,    KC_M_U,     KC_NEXT,    KC_HOME,    _______,
  KC_LPRN,    KC_QUES,    KC_M_L,     KC_M_D,     KC_M_R,     KC_END,
  _______,    KC_EXLM,    KC_AT,      KC_HASH,    KC_DLR,     KC_PERC,    _______,
  _______,    KC_LGUI,    _______,    _______,    KC_M_B3,
  ...
  //righthand
  KC_F12,     KC_F6,      KC_F7,      KC_F8,      KC_F9,      KC_F10,     MO(L_CONF),
  KC_M_WD,    _______,    KC_PGDN,    KC_PGUP,    KC_SPC,     KC_LALT,    _______,
              KC_LEFT,    KC_DOWN,    KC_UP,      KC_RIGHT,   KC_COLN,    KC_RPRN,
  KC_M_WU,    KC_CIRC,    KC_AMPR,    KC_ASTR,    KC_LPRN,    KC_RPRN,    KC_M_A0,
                          KC_PIPE,    _______,    _______,    _______,    _______,
 ...
 */
 [L_NUM] = KEYMAP(
  ...
  _______,    _______,    KC_P1,      KC_P2,      KC_P3,      _______,    _______,
                          KC_P0,      _______,    KC_PDOT,    _______,    _______,
