...
[L_COMMON] = KEYMAP(  // layer 0 : default
  ...
  _______,    _______,    KC_BSLS,    KC_GRV,     SFT_T(KC_QUOT),
  ...
  _______,    _______,    _______,    _______,    _______,    _______,    KC_EQL,
                          SFT_T(KC_MINS),    KC_BSPC,    KC_DEL,     _______,    _______,
...
[L_NAV] = KEYMAP(
  ...
  _______,    _______,    KC_PREV,    KC_M_U,     KC_NEXT,    KC_M_WU,    _______,
  ...
  _______,    KC_HOME,    KC_PGUP,    KC_UP,      KC_PGDN,    _______,    _______,
              KC_END,     KC_LEFT,    KC_DOWN,    KC_RIGHT,   KC_COLN,    KC_RPRN,
  _______,    KC_CIRC,    KC_AMPR,    KC_ASTR,    _______,    KC_SCLN,    _______,
                          _______,    _______,    _______,    _______,    _______,
