...
[SYMB] = KEYMAP(
    ...
    KC_TRNS,    KC_TRNS,        KC_MS_ACCEL2, KC_MS_ACCEL0,   KC_MS_ACCEL1,
    ...
    KC_MS_WH_UP,    KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,
    ...
    KC_TRNS,    KC_TRNS,
    KC_TRNS,
    KC_TRNS,    KC_MS_WH_LEFT,    KC_MS_WH_RIGHT
),
/* Keymap 2: Cursor keys
 *
 * ,--------------------------------------------------.           ,--------------------------------------------------.
 * |  RESET |      |      |      |      |      |      |           |      |      |      |      |      |      | Home   |
 * |--------+------+------+------+------+-------------|           |------+------+------+------+------+------+--------|
...
[CRSR] = KEYMAP(
    ...
    KC_TRNS,    KC_PGUP,    KC_HOME,    KC_UP,      KC_END,     KC_TRNS,    KC_PGUP,
